...
urlpatterns = [
    ...
    path('services/<str:id>/service-detail/',
         views.services_detail, name="service-detail"),
    path('service-search-map/', views.service_search_map,
         name="service-search-map"),
    path('candidates/candidate-detail/<int:id>',
         views.candidate_detail, name="candidate-detail"),
    ...
    path('manage-applicants/<int:id>',
         views.manage_applicant, name="manage-applicant"),
